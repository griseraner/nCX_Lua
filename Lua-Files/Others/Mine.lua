...
Mine = {
	...
	Server = {
		OnInit = function(self)
			System.LogAlways("Server.OnInit");
		...
		Armed = {
			OnBeginState = function(self)
				System.LogAlways("ServerArmed.OnBeginState");
			...
			OnEnterArea = function(self,entity,areaId)
				System.LogAlways("ServerArmed.OnEnterArea");
			...
			OnLeaveArea = function(self,entity,areaId)
				System.LogAlways("ServerArmed.OnLeaveArea");
			...
			OnTimer = function(self,timerId)
				System.LogAlways("ServerArmed.OnTimer");
		...
		Disarmed = {
			OnBeginState = function(self)
				System.LogAlways("ServerDisarmed.OnBeginState");
				self.disarmed=1;
				for i,v in pairs(self.ents) do
					table.remove(self.ents,i);
				end
		...
		Destroyed = {
			OnBeginState = function( self )
				System.LogAlways("ServerDestroyed.OnBeginState");
				local props=self.Properties.FrogMine;
				if(props.bIsFrogMine==1)then
					if(self:IsDead())then
			...
			OnTimer = function(self,timerId)
				System.LogAlways("ServerDestroyed.OnTimer");
	...
	OnReset = function(self)
		System.LogAlways("Server.OnReset");
	...
	OnSave = function(self, tbl)
		System.LogAlways("Server.OnSave");
	...
	CheckEntities = function(self)
		System.LogAlways("CheckEntities");
		local speed;
	...
	-----------------------------------------------------------------------------------
	Event_Disarmed = function(self)
		self:GotoState("Disarmed");
		BroadcastEvent(self, "Disarmed")
	end,

	Event_Detonated = function(self)
		self:GotoState("Destroyed");
		BroadcastEvent(self, "Detonated")
	end,
