...
--Script.ReloadScript("Server/Lua-Files/AI/Misc/Shark_x.lua");
...
-----------------------------------------------------------------------------------------------------
System.LogAlways("Shark 1");
CreateActor(Shark_x);
System.LogAlways("Shark 2");
Shark = CreateAI(Shark_x);
System.LogAlways("Shark 3");
Shark:Expose();
System.LogAlways("Shark 4");
